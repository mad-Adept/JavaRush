...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        Cat catOldFather = new Cat(OldFatherName, null, null);

        String OldMotherName = reader.readLine();
        Cat catOldMother = new Cat(OldMotherName, null, null);
    ...
    public static class Cat
    {
        ...
        public String toString()
        {
            ...
            {
                return "Cat name is " + name + "mother is " + parent + ", no father";
            }
            else if (parent2 != null){

                return "Cat name is " + name + " no mother, father is " + parent2;
            }

            else return "Cat name is " + name + ", mother is " + parent + ", father is " + parent2;
            }
